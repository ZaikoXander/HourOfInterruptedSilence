...
test.describe.serial('Testing timer functionality during source transitions', () => {
  ...
  test('Transition sequence: Youtube video -> Video file -> Audio file', async ({ page }) => {
  ...
  test('Transition sequence: Video file -> Youtube video -> Audio file', async ({ page }) => {
    await expect(timer).toHaveText('01:00:00')
    await expect(startOrPauseOrResumeButton).toBeDisabled()
    await expect(startOrPauseOrResumeButton).toHaveText('Começar')
    await expect(resetButton).toBeDisabled()
  ...
  test('Transition sequence: Audio file -> Youtube video -> Video file', async ({ page }) => {
    await expect(timer).toHaveText('01:00:00')
    await expect(startOrPauseOrResumeButton).toBeDisabled()
    await expect(startOrPauseOrResumeButton).toHaveText('Começar')
    await expect(resetButton).toBeDisabled()
